  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text('Welcome Back,', style: TextStyle(color: Colors.black54, fontFamily: kprimaryfont)),
          ...
          Row(
            ...
            children: const [
              Text(
                'Ana',
                style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, fontFamily: kprimaryfont),
              ),
              CircleAvatar(
                radius: 20,
